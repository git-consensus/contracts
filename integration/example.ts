...
import { ALICE_ADDR, BOB_ADDR, CHARLIE_ADDR, DAVE_ADDR, EXAMPLE_TOKEN_ADDR } from "../scripts";
...
export function commitExamplesNoAddr(): Commit[] {
...
export function commitExamplesWithAddr(): Commit[] {
    const commits: Commit[] = [];

    // c4
    commits.push({
        hash: `0cd3c6a3887a47b21e1efa61e524d2cc98defb90`,
        ownerAddr: ALICE_ADDR,
        data: {
            tree: `tree 4844a6d812f2bb3e1d6d35f2dd9cea71e28eeccb\n`,
            parents: `parent 0716f9facad1b33b0a994d97658e63c00a0cacfd\n`,
            author: `author Alice <alice@foo.com> 1662172540 -0700\n`,
            committer: `committer Alice <alice@foo.com> 1662172540 -0700\n`,
            message: `\nadd A to file.txt 0xf304255aF88d457Ba221525F3C36188016AFE08E\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


=P1bv
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c5
    commits.push({
        hash: `618dfb41eb263ed5cc1a6a9ec5c9f8fe8c61947c`,
        ownerAddr: BOB_ADDR,
        data: {
            tree: `tree a7e8988070f43f5909722db37c32fba2dd1369e2\n`,
            parents: `parent 0cd3c6a3887a47b21e1efa61e524d2cc98defb90\n`,
            author: `author Bob <bob@bar.org> 1662172592 -0700\n`,
            committer: `committer Bob <bob@bar.org> 1662172592 -0700\n`,
            message: `\nadd B to file.txt 0x39E5949217828f309bc60733c9EDbF2f1F522449\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


DQT4
=OpVJ
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c6
    commits.push({
        hash: `69bc539313e2aa84b0c2d166c5aec2572a4a24f1`,
        ownerAddr: CHARLIE_ADDR,
        data: {
            tree: `tree 10c4b16d84bf8d2b325b30b6ccb11077dd7ef3f6\n`,
            parents: `parent 618dfb41eb263ed5cc1a6a9ec5c9f8fe8c61947c\n`,
            author: `author Charlie <charlie@mail.net> 1662172697 -0700\n`,
            committer: `committer Charlie <charlie@mail.net> 1662172697 -0700\n`,
            message: `\nadd C to file.txt 0xc66EF5281FF553f04a64BC4700146606DB921062\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


=La9g
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c7
    commits.push({
        hash: `9b42169c9efe329489b74984ef7250bfa0a9681c`,
        ownerAddr: DAVE_ADDR,
        data: {
            tree: `tree 35fc227d46fdbe1bfe3dda7e61a612f9e4c7a2b9\n`,
            parents: `parent 69bc539313e2aa84b0c2d166c5aec2572a4a24f1\n`,
            author: `author Dave <dave@example.edu> 1662172827 -0700\n`,
            committer: `committer Dave <dave@example.edu> 1662172827 -0700\n`,
            message: `\nadd D to file.txt 0x6E503a5c6C41b5A68cD3Bfff98d8B04bc45CAf93\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


=iFSs
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c8
    commits.push({
        hash: `2ca0e4bd904c69a38cbe3d2d4bccd7fd87876cde`,
        ownerAddr: ALICE_ADDR,
        data: {
            tree: `tree c5a47dec86b3f2d82f707938a32044b43de5a819\n`,
            parents: `parent 9b42169c9efe329489b74984ef7250bfa0a9681c\n`,
            author: `author Alice <alice@foo.com> 1662173016 -0700\n`,
            committer: `committer Alice <alice@foo.com> 1662173016 -0700\n`,
            message: `\nA to AA in file.txt 0xf304255aF88d457Ba221525F3C36188016AFE08E\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


=OwOp
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c9
    commits.push({
        hash: `b9e3a66b06076df455d251115147a130458dcef2`,
        ownerAddr: BOB_ADDR,
        data: {
            tree: `tree b1d85fd547a1dab6b38d4d2762b4fb0ca4b71e55\n`,
            parents: `parent 2ca0e4bd904c69a38cbe3d2d4bccd7fd87876cde\n`,
            author: `author Bob <bob@bar.org> 1662173057 -0700\n`,
            committer: `committer Bob <bob@bar.org> 1662173057 -0700\n`,
            message: `\nB to BB in file.txt 0x39E5949217828f309bc60733c9EDbF2f1F522449\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


YHq6
=lPgy
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c10
    commits.push({
        hash: `d9bfa3300bc651766755acd8087454e4d8fe99b0`,
        ownerAddr: CHARLIE_ADDR,
        data: {
            tree: `tree 3c01344b927ccdc15facea317ff965961bcb7006\n`,
            parents: `parent b9e3a66b06076df455d251115147a130458dcef2\n`,
            author: `author Charlie <charlie@mail.net> 1662173113 -0700\n`,
            committer: `committer Charlie <charlie@mail.net> 1662173113 -0700\n`,
            message: `\nC to CC in file.txt 0xc66EF5281FF553f04a64BC4700146606DB921062\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


=yeTG
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c11
    commits.push({
        hash: `babbe3755b4ce7cdb6572495156d401d69347b16`,
        ownerAddr: DAVE_ADDR,
        data: {
            tree: `tree fc852b7ca2855933c5f25d62679a0374858a9cb7\n`,
            parents: `parent d9bfa3300bc651766755acd8087454e4d8fe99b0\n`,
            author: `author Dave <dave@example.edu> 1662173183 -0700\n`,
            committer: `committer Dave <dave@example.edu> 1662173183 -0700\n`,
            message: `\nD to DD in file.txt 0x6E503a5c6C41b5A68cD3Bfff98d8B04bc45CAf93\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


=cxhI
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c12
    commits.push({
        hash: `9a0a5864111737dcf0dee757997f8b82a53e29f2`,
        ownerAddr: ALICE_ADDR,
        data: {
            tree: `tree 0b7ef87f27d33ef9f332b63ddbff030514a951e1\n`,
            parents: `parent babbe3755b4ce7cdb6572495156d401d69347b16\n`,
            author: `author Alice <alice@foo.com> 1662227441 -0700\n`,
            committer: `committer Alice <alice@foo.com> 1662227441 -0700\n`,
            message: `\nAA to AAA in file.txt 0xf304255aF88d457Ba221525F3C36188016AFE08E\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


=Fbzh
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c13
    commits.push({
        hash: `a7645f13560c99eafea6e9d71c80b74877ee1e4e`,
        ownerAddr: BOB_ADDR,
        data: {
            tree: `tree 0a47fcd0ec434913200199b92d415eb6c75ede15\n`,
            parents: `parent 9a0a5864111737dcf0dee757997f8b82a53e29f2\n`,
            author: `author Bob <bob@bar.org> 1662227494 -0700\n`,
            committer: `committer Bob <bob@bar.org> 1662227494 -0700\n`,
            message: `\nBB to BBB in file.txt 0x39E5949217828f309bc60733c9EDbF2f1F522449\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


5XS/
=Y8ee
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c14
    commits.push({
        hash: `1da9b6c0c1678a21d783f36b0b5bfce2fa527f6c`,
        ownerAddr: CHARLIE_ADDR,
        data: {
            tree: `tree 973d9246a2e6d6652c2d627abff2b7549cad7d8f\n`,
            parents: `parent a7645f13560c99eafea6e9d71c80b74877ee1e4e\n`,
            author: `author Charlie <charlie@mail.net> 1662228104 -0700\n`,
            committer: `committer Charlie <charlie@mail.net> 1662228104 -0700\n`,
            message: `\nCC to CCC in file.txt 0xc66EF5281FF553f04a64BC4700146606DB921062\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


=+LW+
-----END PGP SIGNATURE-----`
                    .split(`\n`)
    ...
    // c15
    commits.push({
        hash: `a0c8c1b5083b1d5eaab179a288bbf79295029b1c`,
        ownerAddr: DAVE_ADDR,
        data: {
            tree: `tree 707e4ab89edcfef3e916582617e40289c3e6ee9d\n`,
            parents: `parent 1da9b6c0c1678a21d783f36b0b5bfce2fa527f6c\n`,
            author: `author Dave <dave@example.edu> 1662228138 -0700\n`,
            committer: `committer Dave <dave@example.edu> 1662228138 -0700\n`,
            message: `\nDD to DDD in file.txt 0x6E503a5c6C41b5A68cD3Bfff98d8B04bc45CAf93\n`,
            signature:
                `gpgsig -----BEGIN PGP SIGNATURE-----


=i7D/
-----END PGP SIGNATURE-----`
                    .split(`\n`)
...
// to call `addRelease()`.
export function tagExamplesNoAddr(): Tag[] {
    const tags: Tag[] = [];
...
export function tagExamplesWithAddr(): Tag[] {
    const tags: Tag[] = [];

    // t3
    tags.push({
        hash: `353f2824d02cf7730cd7c31c92ab91ff772af0c5`,
        tokenAddr: EXAMPLE_TOKEN_ADDR,
        data: {
            object: `object 618dfb41eb263ed5cc1a6a9ec5c9f8fe8c61947c\n`,
            tagType: `type commit\n`,
            tagName: `tag v1.0.0\n`,
            tagger: `tagger Alice <alice@foo.com> 1663127239 -0700\n`,
            message: `\nthird tag 0x1249723FA3B0Adb68D7873fD611691e7B6fBD081\n`,
            signature:
                `-----BEGIN PGP SIGNATURE-----


=ZA2Y
-----END PGP SIGNATURE-----` + `\n`,
        },
    });
    ...
    // t4
    tags.push({
        hash: `a08b408e1659c75161086305a54da5f96f0d6658`,
        tokenAddr: EXAMPLE_TOKEN_ADDR,
        data: {
            object: `object 9b42169c9efe329489b74984ef7250bfa0a9681c\n`,
            tagType: `type commit\n`,
            tagName: `tag v1.0.1\n`,
            tagger: `tagger Bob <bob@bar.org> 1663127328 -0700\n`,
            message: `\nforth tag 0x1249723FA3B0Adb68D7873fD611691e7B6fBD081\n`,
            signature:
                `-----BEGIN PGP SIGNATURE-----


=6UZA
-----END PGP SIGNATURE-----` + `\n`,
        },
    });
    ...
    // t5
    tags.push({
        hash: `d7815c9f7ef87b1d746e8ea11f652933ba1a8cb6`,
        tokenAddr: EXAMPLE_TOKEN_ADDR,
        data: {
            object: `object babbe3755b4ce7cdb6572495156d401d69347b16\n`,
            tagType: `type commit\n`,
            tagName: `tag v1.1.0\n`,
            tagger: `tagger Charlie <charlie@mail.net> 1663127338 -0700\n`,
            message: `\nfifth tag 0x1249723FA3B0Adb68D7873fD611691e7B6fBD081\n`,
            signature:
                `-----BEGIN PGP SIGNATURE-----


=nZxM
-----END PGP SIGNATURE-----` + `\n`,
        },
    });
    ...
    // t6
    tags.push({
        hash: `8fccc24d51545cc9d1fca5f3c8e4e6b42c41bafb`,
        tokenAddr: EXAMPLE_TOKEN_ADDR,
        data: {
            object: `object a0c8c1b5083b1d5eaab179a288bbf79295029b1c\n`,
            tagType: `type commit\n`,
            tagName: `tag v1.1.1\n`,
            tagger: `tagger Alice <alice@foo.com> 1663127348 -0700\n`,
            message: `\nsixth tag 0x1249723FA3B0Adb68D7873fD611691e7B6fBD081\n`,
            signature:
                `-----BEGIN PGP SIGNATURE-----


=rRph
-----END PGP SIGNATURE-----` + `\n`,
        },
    });
